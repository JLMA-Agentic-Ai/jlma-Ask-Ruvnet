    ...
    const KB_DATA = {
        ...
        children: [
            ...
            {
                id: "claude-flow", name: "Claude Flow & Agents", color: "#8b5cf6", count: 70,
                description: "AI orchestration platform with 150+ agent types, swarm coordination, memory systems, and self-learning hooks.",
                children: [
                    {
                        id: "cf-platform", name: "Claude Flow Platform", color: "#8b5cf6", count: 6,
                        description: "The operating system for AI teams: architecture, memory, and hooks.",
                        children: [
                            { id: "cf-p-1", name: "Claude Flow: Operating System for AI Teams", color: "#8b5cf6", description: "Claude Flow is an operating system for AI agents. It spawns, coordinates, and monitors multiple AI agents working together on complex tasks, like a project manager for AI.", tags: ["claude-flow","overview"] },
                            { id: "cf-p-2", name: "Claude Flow Architecture: 10,000-Foot View", color: "#8b5cf6", description: "High-level architecture: CLI layer, MCP server, agent pool, memory system (3 levels), hooks nervous system, and swarm coordinator. 26 commands, 140+ subcommands.", tags: ["architecture","overview"] },
                            { id: "cf-p-3", name: "Claude Flow Memory: Three Levels", color: "#8b5cf6", description: "Three memory tiers: Working (session), Episodic (task history), Semantic (learned patterns). HNSW-indexed for 150x-12,500x faster retrieval than flat search.", tags: ["memory","hnsw"] },
                            { id: "cf-p-4", name: "Claude Flow Hooks: Nervous System", color: "#8b5cf6", description: "27 hooks + 12 background workers form the nervous system. Pre/post hooks for edits, commands, tasks. Auto-learning from successes and failures.", tags: ["hooks","learning"] },
                            { id: "cf-p-5", name: "Why Claude Flow Exists", color: "#8b5cf6", description: "The problem Claude Flow solves: single AI agents hit walls on complex tasks. CF coordinates multiple specialized agents with shared memory and self-learning.", tags: ["motivation","problem"] },
                            { id: "cf-p-6", name: "Claude Flow Limitations", color: "#8b5cf6", description: "Honest assessment of current limitations: token costs, agent drift, context window constraints, and when NOT to use Claude Flow.", tags: ["limitations","honest"] }
                        ]
                    },
                    {
                    ...
                    {
                        id: "cf-ecosystem", name: "Claude Flow Ecosystem", color: "#c084fc", count: 8,
                        description: "The extended Claude Flow package ecosystem: MCP servers, guidance, codex adapters, quality engineering, and cloud platform.",
                        children: [
                            ...
                            { id: "cf-eco-3", name: "@claude-flow/codex v3.0.0-alpha.9", color: "#c084fc", description: "OpenAI Codex CLI integration for Claude Flow. Bridges Claude Flow agent orchestration to the Codex platform with AGENTS.md support.", tags: ["codex","openai","adapter"] },
                            { id: "cf-eco-4", name: "flow-nexus v0.1.128 (Cloud Platform)", color: "#c084fc", description: "Cloud-hosted AI orchestration: sandboxes, workflows, swarm deployment, neural training, app store, and credit-based billing. The SaaS layer on top of Claude Flow.", tags: ["cloud","saas","platform"] },
                            ...
                            { id: "cf-eco-8", name: "Gemini Code Flow", color: "#c084fc", description: "Gemini CLI adaptation of Claude Flow: brings the same agent orchestration, SPARC methodology, and swarm patterns to Google's Gemini ecosystem.", tags: ["gemini","adaptation","cross-platform"] }
                        ]
                    }
                ]
            },
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "sec-p-3", name: "Claude Flow Security CLI", color: "#dc2626", description: "Security scanning from the command line: npx @claude-flow/cli security scan --depth full. Covers CVEs, input validation, path security, and injection protection.", tags: ["cli","scanning"] },
                            { id: "sec-p-4", name: "Claude Flow Adversarial Model", color: "#dc2626", description: "How Claude Flow models adversarial scenarios: threat modeling, attack surface analysis, and automated red-teaming for AI systems.", tags: ["adversarial","modeling"] },
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "t-c-12", name: "What Is Claude Flow", color: "#34d399", description: "An operating system for AI teams. It spawns agents, assigns tasks, manages memory, and coordinates work. Like a project manager that never sleeps and learns from every project.", tags: ["claude-flow","teaching"] },
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "t-d-8", name: "Build vs Buy: Claude Flow", color: "#047857", description: "When to build custom orchestration vs using Claude Flow. CF wins when you need swarms, memory, hooks, or multi-model routing.", tags: ["build-buy","decision"] },
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "t-dd-2", name: "What Claude Flow Should Do Automatically", color: "#166534", description: "Vision document: auto-swarm detection, self-healing agents, predictive task routing, continuous optimization, and zero-config deployment.", tags: ["vision","automation"] },
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "t-g-3", name: "Claude Flow Glossary: 25 Terms", color: "#15803d", description: "Claude Flow specific terms: agent, swarm, hook, worker, topology, consensus, memory tier, SPARC, hive mind, and 16 more.", tags: ["glossary","claude-flow"] },
                ...
                children: [
                    {
                        ...
                        description: "Video series covering Claude Flow V3 architecture, self-learning, security, and community.",
                        children: [
                            { id: "v-cf-1", name: "CF V3: Architecture, Agents, Workers", color: "#ec4899", description: "Deep dive into V3 architecture: new agent pool, background workers, hooks nervous system, and the shift from V2 sequential to V3 concurrent execution.", tags: ["video","cf-v3","architecture"] },
                            { id: "v-cf-2", name: "CF V3: Self-Learning Vector Systems", color: "#ec4899", description: "How V3 uses HNSW-indexed pattern memory to learn from every task. Neural pattern training, experience replay, and knowledge distillation in action.", tags: ["video","cf-v3","learning"] },
                            { id: "v-cf-3", name: "CF V3: Security & Self-Learning", color: "#ec4899", description: "Security architecture in V3: AIMDS integration, adversarial testing, and how the security system learns from attacks to improve defenses.", tags: ["video","cf-v3","security"] },
                            { id: "v-cf-4", name: "CF V3: Everything Revealed", color: "#ec4899", description: "Comprehensive overview of all V3 features: 26 commands, 140+ subcommands, 12 workers, 27 hooks, and the complete ecosystem.", tags: ["video","cf-v3","complete"] },
                            { id: "v-cf-5", name: "CF V3: Community QE Fleet", color: "#ec4899", description: "Community quality engineering: how the open-source community tests, validates, and improves Claude Flow through collaborative QE fleets.", tags: ["video","cf-v3","community"] },
                            { id: "v-cf-6", name: "CF V3: Hive Mind Architecture", color: "#ec4899", description: "Hive mind consensus deep dive: Byzantine fault tolerance, Raft leader election, gossip protocols, and how agents achieve distributed agreement.", tags: ["video","cf-v3","hive-mind"] },
                            { id: "v-cf-7", name: "Claude-Flow V3 Release: 500K Downloads", color: "#ec4899", description: "Milestone celebration and retrospective on the V3 release reaching 500,000 downloads. Community growth, adoption patterns, and roadmap.", tags: ["video","cf-v3","milestone"] }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "v-e-11", name: "Claude Flow CLI Masterclass", color: "#831843", description: "Complete CLI walkthrough: all 26 commands, key subcommands, workflow examples, and power-user tips.", tags: ["video","cli","masterclass"] },
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            { id: "inf-e-1", name: "RuvNet Ecosystem: How All Pieces Connect", color: "#0e7490", description: "Map of the complete ecosystem: RuVector (database) + Claude Flow (orchestration) + AIMDS (security) + RVF (containers). How they interact.", tags: ["ecosystem","map"] },
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { id: "repo-2", name: "claude-flow v3.1.0 (AI Orchestration)", color: "#22d3ee", description: "Claude Flow V3.1: The #1 ranked agent-based framework. 60+ specialized agents, swarm coordination, MCP server, self-learning hooks, vector memory. TypeScript.", tags: ["github","orchestration","agents"] },
