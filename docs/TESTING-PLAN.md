...
This document defines the comprehensive testing strategy for the AskRuvNet application — a Node.js/Express RAG (Retrieval-Augmented Generation) server backed by a PostgreSQL knowledge base of 55,111 enriched entries, ONNX embeddings (all-MiniLM-L6-v2, 384 dimensions), and Groq LLM (llama-3.3-70b-versatile).
