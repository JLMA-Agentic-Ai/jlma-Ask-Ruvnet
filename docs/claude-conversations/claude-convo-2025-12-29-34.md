...
<agent-notification>
<agent-id>a055af5</agent-id>
<output-file>/tmp/claude/-Users-stuartkerr-Code-Ask-Ruvnet-Ask-Ruvnet/tasks/a055af5.output</output-file>
<status>completed</status>
<summary>Agent "Extract troubleshooting guide" completed.</summary>
