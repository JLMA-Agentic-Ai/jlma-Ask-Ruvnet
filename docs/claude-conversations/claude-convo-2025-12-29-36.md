...
<agent-notification>
<agent-id>a67a72a</agent-id>
<output-file>/tmp/claude/-Users-stuartkerr-Code-Ask-Ruvnet-Ask-Ruvnet/tasks/a67a72a.output</output-file>
<status>completed</status>
<summary>Agent "Extract GPT/ChatGPT repos" completed.</summary>
