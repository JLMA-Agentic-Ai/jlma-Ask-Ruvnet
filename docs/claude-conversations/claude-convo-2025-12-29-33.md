...
<agent-notification>
<agent-id>a8a06cc</agent-id>
<output-file>/tmp/claude/-Users-stuartkerr-Code-Ask-Ruvnet-Ask-Ruvnet/tasks/a8a06cc.output</output-file>
<status>completed</status>
<summary>Agent "Create cross-reference mapping" completed.</summary>
