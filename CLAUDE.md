...
### 🔄 CRITICAL: RuvNet Skills Sync Rule

**When updating `/ruvnet-update` or `/ruvnet-stack`, you MUST sync to ALL 4 locations:**

```bash
# 1. Global command (source of truth)
~/.claude/commands/ruvnet-update.md
~/.claude/commands/ruvnet-stack.md

# 2. Global skill (copy of command)
~/.claude/skills/ruvnet-update.md
~/.claude/skills/ruvnet-stack.md

# 3. Shareable skills (for distribution)
docs/shareable-skills/skills/ruvnet-update.md
docs/shareable-skills/skills/ruvnet-stack.md

# 4. Architecture docs (reference copy)
docs/architecture/claude-skills/ruvnet-update.md
docs/architecture/claude-skills/ruvnet-stack.md
```

**NEVER let these get out of sync. After ANY edit, copy to all 4 locations.**
