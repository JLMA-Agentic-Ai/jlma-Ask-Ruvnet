...
- Okay it's reloaded so now can you con- confirm that the front end design stu skill has full access to Imogen and knows how and where to pull images in to make the websites that much more effective ???
