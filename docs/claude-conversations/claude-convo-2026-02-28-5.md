...
Great, so does that mean it’s finally working and to end in the appropriate way?
...
So upgrade it do whatever you need to do I want this thing working completely. I also wanna make sure the application is providing super high quality output. I want you grading the output of the application. Everything else is just an input to that. Let me know when you have that output showing up as a 98 out of 100 or better in terms of quality education, educational using imagery getting things done being communicative, being intelligent, offering options, etc. etc. it’s up to you to decide how you’re gonna communicate this to get the most effective education possible.
