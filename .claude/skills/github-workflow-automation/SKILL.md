...
```bash
# Usage example
npx ruflo@alpha github gh-coordinator \
...
npx ruflo@alpha github issue-tracker \
...
npx ruflo@alpha github release-manager \
...
npx ruflo@alpha github repo-architect \
...
npx ruflo@alpha github ci-orchestrator \
...
npx ruflo@alpha github sync-coordinator \
