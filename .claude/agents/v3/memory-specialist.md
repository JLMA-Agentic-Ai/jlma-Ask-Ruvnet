...
npx ruflo@v3alpha memory init --backend=hybrid --hnsw-enabled

# Memory health check
npx ruflo@v3alpha memory health

# Search memories
npx ruflo@v3alpha memory search -q "authentication patterns" --namespace="patterns"

# Consolidate memories
npx ruflo@v3alpha memory consolidate --strategy=hybrid --retention=0.7

# Export/import namespaces
npx ruflo@v3alpha memory export --namespace="project:myapp" --format=json
npx ruflo@v3alpha memory import --file="backup.json" --namespace="project:myapp"

# Memory statistics
npx ruflo@v3alpha memory stats --namespace="default"

# Quantization
npx ruflo@v3alpha memory quantize --namespace="embeddings" --method=int8
```
