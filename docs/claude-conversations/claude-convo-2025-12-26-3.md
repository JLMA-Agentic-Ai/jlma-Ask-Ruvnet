...
## Human
 ...
 Okay I restarted but I did it in continue mode so you'd know the conversation we're having can you confirm you can still see the MCP for Imogen ?
...
Okay I ran them is that a one time thing or will I have to do that every time Because that's certainly not my goal Can you store the token so that shows that they're fully loaded and enhaced and authorized permanently?
