...
Ruflo is the ultimate multi-terminal orchestration platform that revolutionizes how you work with Claude Code.
...
## Best Practices
- Use `./ruflo` instead of `npx ruflo` after initialization
