...
# Use alpha features
npx ruflo@alpha sparc run <mode> "task description"
...
```bash
# Before work
npx ruflo@alpha hooks pre-task --description "implement auth"

# During work
npx ruflo@alpha hooks post-edit --file "auth.js"

# After work
npx ruflo@alpha hooks post-task --task-id "task-123"
```
