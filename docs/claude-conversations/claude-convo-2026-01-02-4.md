...
I want the knowledge base query scoring near perfect. I don't understand why it would be anything less. This thing is now the world-class version of all the knowledge. What would a perfect KB query test score be? 
